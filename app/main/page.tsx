...
async function MainPage() {
  ...
  return (
    <HydrationBoundary state={dehydratedState}>
      <main className="mx-auto my-16 w-full max-w-[1200px] mb:flex mb:flex-col mb:items-center tbc:flex tbc:flex-col tbc:items-center tbr:flex tbr:flex-col tbr:items-center  pc:grid pc:grid-cols-[230px_minmax(976px,_1fr)] pc:grid-rows-[100px_minmax(800px,_1fr)]">
        <SelectStack />
      </main>
    </HydrationBoundary>
  );
