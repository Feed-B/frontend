...
function WriteCommentSection() {
  return (
    <section className="flex flex-col gap-4 p-6">
      <p className="text-base font-bold text-gray-900">프로젝트를 평가해주세요</p>
      ...
      <div className="flex h-32 gap-1 rounded-lg bg-gray-100 p-3 text-gray-500">
        <textarea
          className="bg-transparent h-full w-full resize-none outline-none"
          placeholder="주제와 무관한 댓글은 삭제될 수 있습니다."
        />
        <div className="flex flex-col justify-between">
          <p className="text-end text-sm text-gray-600">0/150</p>
