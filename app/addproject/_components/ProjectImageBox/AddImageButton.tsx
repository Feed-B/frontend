...
function AddImageButton({ count, onClick }: AddImageButtonProps) {
  return (
    <div
      className="flex cursor-pointer items-center justify-center rounded-xl border-2 border-dashed border-blue-500 bg-white hover:bg-blue-50 mb:min-h-[72px] mb:min-w-[72px] tbc:min-h-[72px] tbc:min-w-[72px] tbr:min-h-[124px] tbr:min-w-[124px] pc:hidden"
      onClick={onClick}>
