...
const Section = ({ children }: { children: ReactNode }) => {
  return <section className="mx-auto flex w-full flex-col items-center gap-3">{children}</section>;
};
...
export default function Home() {
  return (
    <main className="w-full bg-gray-100">
      <section className="mx-auto flex w-full justify-center gap-[164px] pt-[60px]">
